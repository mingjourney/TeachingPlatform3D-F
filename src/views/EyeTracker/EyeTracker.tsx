  ...
  return (
    <div className="p-2">
      <div className="flex justify-between gap-10">
        <div className="border-2 border-black-200 text-center p-4">
          <div className="relative">
            <video id="webcam" width="200px" autoPlay playsInline></video>
            <canvas
              id="output-canvas"
        ...
        <div className="flex-1 border-2 border-black-200 p-4">
